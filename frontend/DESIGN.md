...
- **3D gallery (ref. scrolling photo gallery)**: małe lekko zaokrąglone kwadraty (`rounded-[12px]`) w pionowych kolumnach na cylindrze.
- Kolumny **przesuwają się w lewo ↔ prawo** (auto sine + kursor na osi X).
